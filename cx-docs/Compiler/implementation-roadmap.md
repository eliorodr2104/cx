...
| M4 | Struct methods, `self`, access, continuations, `~mutating`, initializers | No stored layout change; trivial generated construction | **Completed** ([M4a](milestones/M4a.md), [M4b](milestones/M4b.md), [M4c](milestones/M4c.md), [M4d](milestones/M4d.md), [M4e](milestones/M4e.md), [M4f](milestones/M4f.md), [M4.1](milestones/M4.1.md), [M4.2](milestones/M4.2.md), [M4.3](milestones/M4.3.md)); hardening [M4.4](milestones/M4.4.md) and [M4.5](milestones/M4.5.md) completed, [M4.6](milestones/M4.6.md)–[M4.7](milestones/M4.7.md) planned |
| M5 | Semicolon elision and core syntax disambiguation | G01 rules and regression corpus before broad enablement | ([M5a](milestones/M5a.md) planned) |
