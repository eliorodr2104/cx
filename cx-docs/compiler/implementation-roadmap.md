...
| M6 | Tuples, payload enums, OptionSet core | Validity/layout, pattern matching, legacy enum preservation | ([M6a](milestones/M6a.md) completed; M6b raw and simple enums, M6c payload enums, M6d pattern matching, M6e OptionSet planned) |
