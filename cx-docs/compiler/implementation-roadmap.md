...
| M6.2 | Enum hardening | Expected type for payload arguments (`.wrap(.red)`); no `goto` into a Cx switch clause | |
| M7 | Unified cleanup and value operations | Defer, copy/destruction, partial initialization tests | ([M7a](milestones/M7a.md), [M7b](milestones/M7b.md) completed) |
