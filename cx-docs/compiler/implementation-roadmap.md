...
| M5 | Semicolon elision and core syntax disambiguation | G01 rules and regression corpus before broad enablement | ([M5a](milestones/M5a.md), [M5b](milestones/M5b.md) completed) |
| M6 | Tuples, payload enums, OptionSet core | Validity/layout, pattern matching, legacy enum preservation | ([M6a](milestones/M6a.md), [M6b](milestones/M6b.md), [M6c](milestones/M6c.md), [M6d](milestones/M6d.md), [M6e](milestones/M6e.md) completed; then M6.1, `.case` for struct fields in braces and tuple literal elements, resolved against the destination after parsing) |
