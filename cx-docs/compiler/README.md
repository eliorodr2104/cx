...
- [AST Strategy](ast.md)
- [Implementation Benchmark Checkpoints](benchmarking.md)
- [Clang Integration](clang-integration.md)
- [Code Generation](codegen.md)
- [Compiler Compatibility Contract](compatibility.md)
- [Diagnostics](diagnostics.md)
- [Feature and Documentation Traceability](feature-matrix.md)
...
[Root index](../README.md) | [Decisions](../DECISIONS.md) | [Implementation gates](../OPEN-ISSUES.md)
